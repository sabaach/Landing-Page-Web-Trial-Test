      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight max-w-2xl">
            ...
            <div className="flex items-center text-sm text-white/60 pt-4">
          ...
          >
            <div className="glass-card p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="text-sm text-white/70 mb-1">E-commerce Market</div>
                  <div className="font-display text-3xl font-extrabold text-white">US$206B</div>
                  <div className="text-xs text-success mt-1">+11.6% YoY</div>
                </div>
                <div>
                  <div className="text-sm text-white/70 mb-1">Internet Penetration</div>
                  <div className="font-display text-3xl font-extrabold text-white">97.6%</div>
