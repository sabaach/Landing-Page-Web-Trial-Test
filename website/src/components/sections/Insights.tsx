...
export function Insights() {
  ...
  return (
    <SectionWrapper background="light" id="insights" className="overflow-hidden">
      ...
      <div className="relative -mx-4 sm:mx-0">
        <motion.div 
          ...
          className="flex sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 overflow-x-auto sm:overflow-visible px-4 sm:px-0 pb-4 sm:pb-0 snap-x snap-mandatory hide-scrollbar"
        >
          {insights.map((insight, index) => (
            <motion.div key={index} variants={itemVariants} className="min-w-[260px] sm:min-w-0 w-[75vw] sm:w-auto max-w-[320px] sm:max-w-none snap-start flex-shrink-0 sm:flex-shrink">
              <a href="#" className="group block h-full">
                <div className="bg-white rounded-2xl overflow-hidden border border-neutral-200 shadow-sm transition-all duration-300 group-hover:shadow-lg group-hover:-translate-y-1 h-full flex flex-col">
                  ...
                  <div className="p-4 sm:p-6 flex flex-col flex-grow">
                    <h3 className="text-base sm:text-lg font-bold text-neutral-900 mb-3 sm:mb-4 line-clamp-3 group-hover:text-primary-600 transition-colors">
                      {insight.title}
                    </h3>
